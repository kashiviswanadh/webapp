/*1654429092,,JIT Construction: v1005633232,en_US*/
...
try {
            ...
            with(this) {
                ...
                __d("ChatPluginStyleUtils", [], (function(a, b, c, d, e, f) {
                    ...
                    function F(a, b, c, d, e, f) {
                        c = c - A;
                        var i = A;
                        e === "none" ? f === "compact" ? i += r : i += q : f === "compact" ? i += h : i += g;
                        e = i + b;
                        f = {
                            padding: 0,
                            position: "fixed",
                        ...
                        i = babelHelpers["extends"]({}, i, {
                            animation: Boolean(d) ? "slideInFromBottomDelay 6s ease-out" : "slideInFromBottomDelay 3s ease-out"
                        });
                        b = Object.fromEntries(ES("Object", "entries", !1, i).sort());
                    ...
                    f.getDesktopGreetingStyleText = F;
                    f.getMobileGreetingStyleText = G;
                    f.getDesktopWelcomeMessageStyleText = H;
                    f.getMobileWelcomeMessageStyleText = I;
                    f.getMobileReengagementCollapsedDialogStyleText = J;
                    f.getWelcomeMessageBubbleStyle = K;
                    f.getWelcomeMessageTextStyle = L;
                    f.getMinusButtonStyle = M;
                    f.getMinusButtonVisibility = N;
                    f.getNoOutlineFocus = O
                }), 66);
                ...
                __d("sdk.XFBML.CustomerChatNew", ["ChatPluginSDKPreLoggingUtils", "DOMEventListener", "IframePluginClass", "Log", "MPNExplicitUserInteractions", "MPNLocalState", "QueryString", "UrlMap", "getFacebookOriginForTarget", "performanceAbsoluteNow", "sdk.Content", "sdk.DOM", "sdk.DialogUtils", "sdk.Event", "sdk.UA", "sdk.WebStorage", "sdk.XD", "sdk.XFBML.CustomerChatWrapper", "sdk.cp.Actions", "sdk.cp.Animation", "sdk.cp.Constants", "sdk.cp.Storage", "sdk.createIframe"], (function(a, b, c, d, e, f, g) {
                    ...
                    a = function(a) {
                        ...
                        function b(b, c, e, f) {
                            ...
                            g.$CustomerChat15 = !1;
                            g.show = function(a) {
                                a === void 0 && (a = !0), g.$CustomerChat15 = !1, g.$CustomerChat1 != null && d("sdk.DOM").setStyle(g.$CustomerChat1, "display", "inline"), a && g.$CustomerChat27(g.$CustomerChat4), d("sdk.Event").fire("customerchat.show"), g.$CustomerChat29("show")
                            };
                            g.hide = function() {
                                g.$CustomerChat15 = !0, g.$CustomerChat1 != null && d("sdk.DOM").setStyle(g.$CustomerChat1, "display", "none"), g.$CustomerChat26(g.$CustomerChat4), d("sdk.Event").fire("customerchat.hide"), g.$CustomerChat29("hide")
                            };
                            g.showDialog = function() {
                                g.$CustomerChat1 != null && d("sdk.DOM").setStyle(g.$CustomerChat1, "display", "inline"), g.$CustomerChat27(g.$CustomerChat4), g.$CustomerChat29("showDialog")
                            };
                            g.hideDialog = function() {
                                g.$CustomerChat26(g.$CustomerChat4), g.$CustomerChat29("hideDialog")
                            };
                            g.update = function(a) {
                                var b;
                        ...
                        e.$CustomerChat20 = function(a) {
                            ...
                            this.$CustomerChat3 = c("sdk.createIframe")({
                                ...
                                onload: function() {
                                    d("ChatPluginSDKPreLoggingUtils").preLogging("chat_plugin_sdk_icon_iframe_load", b.params), b.$CustomerChat2 = j, b.$CustomerChat23(), b.$CustomerChat24(), window.setTimeout(function() {
                                        d("sdk.DOM").remove(i)
                                    }, 100)
                                }
                            });
                            ...
                            this.$CustomerChat8 = c("sdk.createIframe")({
                                ...
                                onload: function() {
                                    b.$CustomerChat9 = k, b.$CustomerChat23(), b.$CustomerChat24()
                                }
                            });
                            ...
                            this.$CustomerChat6 = c("sdk.createIframe")({
                                ...
                                onload: function() {
                                    b.$CustomerChat7 = l, b.$CustomerChat23(), b.$CustomerChat24()
                                }
                            });
                            ...
                            this.$CustomerChat10 = c("sdk.createIframe")({
                                ...
                                onload: function() {
                                    b.$CustomerChat11 = m, b.$CustomerChat23(), b.$CustomerChat24()
                                }
                            });
                            d("sdk.Content").append(this.$CustomerChat10, g.contentRoot)
                        };
                        e.$CustomerChat24 = function() {
    ...
    i.src = 'https://www.facebook.com/platform/scribe_endpoint.php/?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script || "sdk.js") + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1005633232","namespace":"FB","message":"' + e.message + '"}}');
