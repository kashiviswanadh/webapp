...
__d("Bootloader", ["invariant", "BootloaderConfig", "BootloaderEndpoint", "BootloaderEvents", "BootloaderEventsManager", "CSRBitMap", "CSRIndexUtil", "CSSLoader", "ClientConsistency", "ErrorPubSub", "FBLogger", "JSResourceReferenceImpl", "NetworkStatus", "RequireDeferredReference", "ResourceHasher", "ResourceTimingsStore", "TimeSlice", "cr:696703", "createTrustedScriptURLFromBootloaderDataURI", "createTrustedScriptURLFromFacebookURI", "err", "fb-error", "ifRequireable", "maybeRemoveElement", "nullthrows", "performanceAbsoluteNow", "performanceNow", "setTimeoutAcrossTransitions"], (function(a, b, c, d, e, f, g) {
    ...
    var r = [],
        ...
        F = new Set(),
        G = !1,
        H = new(b("BootloaderEventsManager"))(),
        I = b("BootloaderConfig").jsRetries || [],
        J = b("BootloaderConfig").jsRetryAbortNum,
    ...
    function Q() {
        ...
        if (a < J) return !0;
        a = B[a - 1] - B[a - J];
        a < aa && (b("FBLogger")("bootloader").warn("JS retry abort"), K = !1);
        return K
    }
    ...
    function S(a, c, d, e) {
        ...
        a.onload = h.bind(void 0, function() {
            var d;
            d = (d = A.get(f)) != null ? d : 0;
            d && b("FBLogger")("bootloader").info("JS retry success [%s] at %s | time: %s | retries: %s", c, f, (i || (i = b("performanceAbsoluteNow")))() - g, d);
        ...
        a.onerror = h.bind(void 0, function() {
            var h;
            b("ResourceTimingsStore").measureResponseReceived("js", j);
            h = (h = A.get(f)) != null ? h : 0;
            var k = (i || (i = b("performanceAbsoluteNow")))();
            Q() && h < I.length ? (B.push(k), setTimeout(function() {
                if (!Q()) return;
                var b = a.parentNode;
                b && (b.removeChild(a), R(c, d, e, b))
            }, I[h]), A.set(f, h + 1)) : (v.set(c, k), b("FBLogger")("bootloader").warn("JS loading error [%s] at %s | time: %s | retries: %s | concurrency: %s", c, f, k - g, h, t.size - u.size), b("NetworkStatus").reportError(), e())
        })
    }
    ...
    function U(a, c, d, e, f) {
        ...
        var u = c.onBlocking,
            v = c.onAll,
            w = c.onLog;
        u && H.registerCallback(function() {
            r(u)
        }, f);
        v && H.registerCallback(function() {
            r(v)
        }, j);
        w && H.registerCallback(function() {
            s(function() {
                return w(i)
            })
        }, k);
    ...
    function ha(a, c, e, f) {
        ...
        f && b("nullthrows")(C.get(a)).logData.add(f);
        var g = L(a),
            h = g.r,
            j = g.rdfds,
            k = g.rds;
        g = g.be;
        g = ga(a) ? null : ca(a, g);
        g == null && H.notify(H.beDone(a));
        U(g != null ? [g].concat(h) : h, {
            onAll: function() {
                return H.notify(H.tierOne(a))
            },
            onLog: function() {
                return H.notify(H.tierOneLog(a))
            }
        ...
        U((j == null ? void 0 : j.r) || [], {
            ...
            onAll: function() {
                return H.registerCallback(function() {
                    H.notify(H.tierTwoStart(a)), d.call(null, l.map(b("RequireDeferredReference").getRDModuleName_DO_NOT_USE), function() {
                        return H.notify(H.tierTwo(a))
                    })
                }, [H.tierOne(a), c])
            },
            onLog: function() {
                return H.notify(H.tierTwoLog(a))
            }
        ...
        U((k == null ? void 0 : k.r) || [], {
            ...
            onAll: function() {
                return H.registerCallback(function() {
                    H.notify(H.tierThreeStart(a)), d.call(null, m.map(b("RequireDeferredReference").getRDModuleName_DO_NOT_USE), function() {
                        return H.notify(H.tierThree(a))
                    })
                }, [H.tierTwo(a)])
            },
            onLog: function() {
                return H.notify(H.tierThreeLog(a))
            }
    ...
    function X(a) {
        ...
        c || window._btldr && window._btldr[e] ? d.type === "js" ? f(a) : f() : d.type === "js" ? S(a, e, d, f) : b("CSSLoader").setupEventListeners(e, d.src, O(), f, T(e, d, f), a)
    }
    ...
    var $ = {
        loadModules: function(a, c, e) {
            ...
            var k = j[0],
                l = j[1];
            H.registerCallback(d.bind(null, f, function() {
                l && (l.callbackStart = (i || (i = b("performanceAbsoluteNow")))()), h.apply(void 0, arguments), l && (l.callbackEnd = (i || (i = b("performanceAbsoluteNow")))()), H.notify(k)
            }), f.map(function(a) {
                return H.tierOne(a)
            }));
            P(function(b) {
            ...
            if (l) {
                ...
                for (var m = 0; m < f.length; m++) {
                    ...
                    j.add(H.beDone(n));
                    j.add(H.tierThree(n));
                    j.add(H.tierOneLog(n));
                    j.add(H.tierTwoLog(n));
                    j.add(H.tierThreeLog(n))
                }
                H.registerCallback(function() {
        ...
        requestJSResource_UNSAFE_NEEDS_REVIEW_BY_SECURITY_AND_XFN: function(a) {
            ...
            u.set(a, (i || (i = b("performanceAbsoluteNow")))()), window.CavalryLogger && window.CavalryLogger.done_js([a]), H.notify(H.rsrcDone(a)), c != null && k(c)
        },
        beDone: function(a, b, c) {
            for (var d = (d = (d = C.get(a)) == null ? void 0 : d.logData) != null ? d : [], e = Array.isArray(d), f = 0, d = e ? d : d[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]();;) {
                var d, g;
                if (e) {
                    if (f >= d.length) break;
                    g = d[f++]
        ...
        enableBootload: function(a, b) {
            for (var c in a) b && b.comp++, !w.has(c) ? (w.set(c, a[c]), p.has(c) && (p["delete"](c), M(c))) : b && b.dup_comp++;
            Y();
            q || Z()
        },
        ...
        getBootloadedComponents: function() {
            var a = new Map();
            for (var b = C, c = Array.isArray(b), d = 0, b = c ? b : b[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]();;) {
                var e;
                if (c) {
                    if (d >= b.length) break;
                    e = b[d++]
        ...
        getComponentTiming: function(a) {
            var b;
            return {
                tierTwoStart: (b = H.getEventTime(H.tierTwoStart(a))) != null ? b : 0,
                tierTwoEnd: (b = H.getEventTime(H.tierTwo(a))) != null ? b : 0,
                tierThreeStart: (b = H.getEventTime(H.tierThreeStart(a))) != null ? b : 0,
                tierThreeEnd: (b = H.getEventTime(H.tierThree(a))) != null ? b : 0
            }
        },
...
__d("PluginOptin", ["DOMEvent", "DOMEventListener", "MessengerWebPluginAnonymousTypedLogger", "PlatformWidgetEndpoint", "PluginLoggedOutUserTypedLogger", "PluginMessage", "PopupWindow", "URI", "UserAgent_DEPRECATED"], (function(a, b, c, d, e, f, g) {
    var h = function() {
        function a(a, b) {
            this.return_params = c("URI").getRequestURI().getQueryData(), this.login_params = {}, this.optin_params = {}, this.plugin = a, this.api_key = b, this.addReturnParams({
                ret: "optin"
        ...
        b.start = function() {
            ...
            this.popup = d("PopupWindow").open(b.toString(), 420, 450, "fbPluginAuthenticationPopupWindow");
...
__d("FalcoLoggerTransports", ["AnalyticsCoreData", "Banzai", "JSResource", "ODS", "PersistedQueue", "Queue", "WebSession", "performanceAbsoluteNow", "promiseDone", "uuid"], (function(a, b, c, d, e, f, g) {
    ...
    var h = 5 * 1024,
        ...
        y = Date.now() - n,
        z = 1;
    ((b = c("AnalyticsCoreData").fix_br_init_rc) != null ? b : !1) && O();
    ...
    function B() {
        ...
        t = !1;
        var a = q;
        F("js.br.send_batch", a.map(function(a) {
            return a[1].item
        }));
        if (!x) {
            G("js.br.init_not_complete.log", a.length);
            var b = function() {
                var b = a[c],
                    d = b[0],
                    e = b[1];
            ...
            return b.log(a.map(function(a) {
                ...
                if (!b) {
                    G("js.br.banzai_fallback", a.length);
                    var c = function() {
                        var c = a[d],
                            b = c[0],
                            e = c[1];
    ...
    function N(a) {
        l.start(function(b) {
            return b({
                log: function(d, b) {
                    F("planes.bladerunner.write_to_transport", d);
                    var e = JSON.stringify(C(d));
                    a ? c("AnalyticsCoreData").enable_ack ? c("promiseDone")(a.amendWithAck(e), function(a) {
                        F("planes.bladerunner.ack_received" + a.toString(), d), b(a)
                    }, function() {
                        F("planes.bladerunner.ack_failure", d), b(!1)
                    }) : (a.amendWithoutAck(e), F("planes.bladerunner.write_without_ack", d)) : (F("planes.bladerunner.request_stream_null", d), b(!1))
                },
        ...
        c("JSResource").loadAll([c("JSResource")("TransportSelectingClientSingleton").__setRef("FalcoLoggerTransports"), c("JSResource")("RequestStreamCommonRequestStreamCommonTypes").__setRef("FalcoLoggerTransports")], function(a, b) {
            ...
            b = {
                ...
                onFlowStatus: function(a) {
                    a === e.Started && !((a = c("AnalyticsCoreData").fix_br_init_rc) != null ? a : !1) && N(f)
                }
            };
            c("promiseDone")(a.requestStream({
                ...
                f = a;
                ((a = c("AnalyticsCoreData").fix_br_init_rc) != null ? a : !1) && N(f);
                x = !0
            })["catch"](function(a) {
                l.stop(!0), u = !1
            }))
    ...
    function a() {
        ...
        c("PersistedQueue").setHandler("falco_queue_log", function(a) {
            ...
            while (b = a.dequeueItem())(function(b) {
                P(b.item.policy) ? (H(b.item.name, "js.use_bladerunner.log", 1, !0), O(), s == null && (s = setTimeout(B, i)), A(a, b)) : (H(b.item.name, "js.use_banzai.log", 1, !0), I.log([b.item], function(c) {
        ...
        c("PersistedQueue").setHandler("falco_queue_immediately", function(a) {
            var b;
            while (b = a.dequeueItem())(function(b) {
                P(b.item.policy) ? (H(b.item.name, "js.use_bladerunner.log_immediately", 1, !0), O(), (s == null || !t) && (clearTimeout(s), s = setTimeout(B, j), t = !0), A(a, b)) : (H(b.item.name, "js.use_banzai.log_immediately", 1, !0), I.logImmediately([b.item], function(c) {
                    return a.markItem(b, c)
                }))
            })(b)
        });
        c("PersistedQueue").setHandler("falco_queue_critical", function(a) {
            ...
            while (b = a.dequeueItem())(function(b) {
                var c = b.item;
                P(c.policy) ? (H(c.name, "js.use_bladerunner.log_critical", 1, !0), O(), !x ? (H(c.name, "js.br.init_not_complete.logCritical", 1, !0), I.logCritical([c], function(c) {
                    return a.markItem(b, c)
                })) : l.enqueue(function(d) {
                    return d.logCritical([c], function(d) {
                        if (!d) {
                            G("js.br.banzai_fallback.critical", 1);
                            I.logCritical([c], function(c) {
                                return a.markItem(b, c)
                            });
                            return
                        }
                ...
                })) : (H(c.name, "js.use_banzai.log_critical", 1, !0), I.logCritical([c], function(c) {
                    return a.markItem(b, c)
                }))
            })(b)
        });
        c("AnalyticsCoreData").enable_dataloss_timer && (O(), L(), M())
    }
    g.attach = a
}), 98);
